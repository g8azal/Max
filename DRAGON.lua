...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━● :\na●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━● :\na●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n\27[0;33;49m')
...
io.write('\27[1;31m ●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━● ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
sudo_users = {SUDO,22222222222222,44444444444444,11111111111111,1916366858}   
...
if tonumber(user_id) == tonumber(22222222222222) then  
var = true 
...
local NameUser = " 𖣘  مـن قبـل  ↜:["..data.first_name_.."](T.me/"..UserName..")"
...
send(msg.chat_id_, msg.id_," 𖣘 تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
------by-alex-- 
...
send(msg.chat_id_, msg.id_,' 𖣘لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n 𖣘اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
...
local Text = ' 𖣘تم ارسال الملصق من ●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n - '..Name
...
database:set(bot_id..'Tuasl:Bots',true) 
send(msg.chat_id_, msg.id_,' 𖣘 ارسل لي رد الان')
return false
end
if text == 'مسح رد استارت' and DevSoFi(msg) then 
database:del(bot_id..'Tuasl:Bots') 
send(msg.chat_id_, msg.id_,' 𖣘 تم مسح رد استارت')
end
...
send(msg.chat_id_, msg.id_,' 𖣘 تم مسح كليشه ستارت')
end
...
os.execute('wget https://raw.githubusercontent.com/g8azal/Max/main/DRAGON.lua')
...
local Text = '𖣘انت الان المطور الاساسي في البوت \n 𖣘سورس غزال\n 𖣘يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/G8AZAAL)'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'مطور البوت 🌚💞', url="http://t.me/"..sudos.UserName}}, 
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Ghazal_Source/2107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send(msg.chat_id_, msg.id_,' 𖣘 اصدار سورس غزال{ 3x𖣘}')
end
if text == '●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●' and DevSoFi(msg) then
local Text = [[ 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
 𖣘 من أحسن السورسات على التليجرام سورس غزال 𖣘
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Ghazal_Source/2092&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
DRAGONk = '\n 𖣘 تم ازالة  ↜:↝ '..w..' ↜ كروب لان البوت عضو'
end
...
usertext = '\n 𖣘 الـعـضو   ↜:['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖣘 تم ترقيته مطور'
...
usertext = '\n 𖣘 الـعـضو   ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖣘 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣘 الـعـضو   ↜:[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n 𖣘 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," 𖣘 تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,' 𖣘 عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
...
send(msg.chat_id_,0," 𖣘 الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖣘 ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," 𖣘 الـعـضو  : {["..data.first_name_.."](T.ME/G8AZAAL)}\n 𖣘 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖣘 عذرا  ↜:{["..data.first_name_.."](T.ME/G8AZAAL)}\n 𖣘 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 𖣘عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 𖣘عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖣘 الـجـروب مـفعـل مـن قبـل')
else
sendText(msg.chat_id_,'\n 𖣘 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖣘تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
...
Text = ' 𖣘 تـم تـشغـيل الـبوت فـي الـجـروب جـديد\n'..
'\n 𖣘بواسطة {↝'..Name..'↜}'..
'\n 𖣘ايدي الجروب {'..IdChat..'}'..
'\n 𖣘اسم الجروب {['..NameChat..']}'..
'\n 𖣘عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n 𖣘الرابط {['..LinkGp..']}'
if not DevSoFi(msg) then
sendText(SUDO,Text,0,'md')
end
...
send(msg.chat_id_, msg.id_,' 𖣘 الـبوت مـعطـل مـن قبـل')
else
sendText(msg.chat_id_,'\n 𖣘 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖣘 تـم تـعـطيل الـبوت   {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
local NameChat = chat.title_
local IdChat = msg.chat_id_
...
Text = '\n تـم تـعـطيل الـبوت مـن الـجـروب 𖣘'..
'\n 𖣘بواسطة {↝'..Name..'↜}'..
'\n 𖣘ايدي الجروب {'..IdChat..'}'..
'\n 𖣘اسم الجروب {['..NameChat..']}'..
'\n 𖣘الرابط {['..LinkGp..']}'
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖣘تـم تـشغـيل الـبوت فـي الـجـروب ')
else
sendText(msg.chat_id_,'\n 𖣘 مـن قبـل ↭ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖣘تـم تـشغـيل الـبوت فـي الـجـروب  {'..chat.title_..'}\n  وتم تــرقــيه جــمــيع الـادمــنــيه',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم تفعيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "+-+-+-+-+&--" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' 𖣘 تم تعطيل الالعاب')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
local Text = {
  ...
  "ها شو غيرت صورتك 🤔😹",
  "شكو غيرت صورتك شنو قطيت وحده جديده 😹😹𖣘",
...
if text == '《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》 ' then
local Text = [[ 
 𖣘من أحسن السورسات على التليجرام سورس غزال 𖣘
...
if text == '●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●' then
local Text = [[ 
 𖣘 𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 𖣘
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼', url="t.me/Ghazal_Source"}}, 
...
local Text = [[  
 𖣘 اهلا في قائمه الالعاب المتطوره سورس غزال 𖣘 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣘 تم تعطيل جلب الصوره ،\n 𖣘 تم قفل البوتات  ،\n 𖣘 تم قفل التكرار ،\n 𖣘 تم قفل الروابط ،\n 𖣘 تم قفل التوجيه ،\n 𖣘 تم قفل الملصقات ،\n 𖣘 تم قفل المتحركه ،\n 𖣘 تم قفل الفيديو ،\n 𖣘 تم قفل الفشار ،\n 𖣘 تم قفل الانلاين ،\n 𖣘 تم قفل تعديل المديا ،\n 𖣘 تم وضع التكرار  ،\n 𖣘 تم قفل الفارسيه  ،\n 𖣘 تم وضع الايدي بدون صوره ،n  \n 𖣘 تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣘 تم تفعيل جلب الصوره ،\n 𖣘 تم  فتح البوتات  ،\n 𖣘 تم  فتح التكرار ،\n 𖣘 تم  فتح الروابط ،\n 𖣘 تم  فتح التوجيه ،\n 𖣘 تم  فتح الملصقات ،\n 𖣘 تم  فتح المتحركه ،\n 𖣘 تم  فتح الفيديو ،\n 𖣘 تم  فتح الفشار ،\n 𖣘 تم  فتح الانلاين ،\n 𖣘 تم  فتح تعديل المديا ،\n 𖣘 تم وضع التكرار  ،\n 𖣘 تم  فتح الفارسيه  ،\n 𖣘 تم وضع الايدي بصوره،n \n 𖣘 تم تفعيل الحمايه  بواسطه ، [↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
database:set(bot_id.."lock:text"..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖣘  مـن قبـل  ↜:[↝'..Rutba(msg.sender_user_id_,msg.chat_id_)..'↜](T.ME/'..(data.username_ or 'textchuser')..') \n 𖣘 تـم قفـل الدردشه ')
end,nil)   
...
Text = ' 𖣘 تم تفعيل امر غنيلي الان ارسل غنيلي'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = ' 𖣘 بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖣘 تم تعطيل امر غنيلي'
else
Text = '\n 𖣘 بالتاكيد تم تعطيل امر غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖣘  مـن قبـل  ↜:['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'textchuser')..') \n 𖣘 تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(22222222222222) then  
send(msg.chat_id_, msg.id_, "عذرآ لـآ يمكن حظر المبرمج غزال عام 🚫")
return false 
end
...
function(arg,data) 
usertext = '\n 𖣘 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'G8AZAAL')..')'
status  = '\n 𖣘 تم حظره عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
send(msg.chat_id_, msg.id_, " 𖣘 لا يمكنك حظر مطور السورس عام \n")
return false 
end
...
if result.id_ == tonumber(22222222222222) then
send(msg.chat_id_, msg.id_, "عذرآ لـآ يمكن حظر المبرمج غزال عام 🚫 \n")
return false 
end
usertext = '\n 𖣘 العضو ← ['..result.title_..'](t.me/'..(username or 'G8AZAAL')..')'
status  = '\n 𖣘 تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
send(msg.chat_id_, msg.id_, "لا يمكنك حظر 🧞 مالك السورس 🧞 عام 𖣘")
return false 
end
...
if tonumber(userid) == tonumber(22222222222222) then  
send(msg.chat_id_, msg.id_, "عذرآ لـآ يمكن حظر المبرمج غزال عام 🚫")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(44444444444444) then  
send(msg.chat_id_, msg.id_, " 𖣘 لا تسطيع كتم 🧞 مالك السورس 🧞 عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1916366858) then  
send(msg.chat_id_, msg.id_, " ⚠️ بس يبابا دا مالك السورس ⚠️")
...
function(arg,data) 
usertext = '\n 𖣘 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'G8AZAAL')..')'
status  = '\n 𖣘 تم كتمه عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
usertext = '\n 𖣘 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'G8AZAAL')..')'
status  = '\n 𖣘 تم الغاء (الحظر-الكتم) عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
t = ' 𖣘 ملفات السورس غزال●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n ●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━● \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if Get_info then
local TextS = "\n 𖣘 اهلا بك في متجر ملفات غزال\n 𖣘 ملفات السورس ●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n\n"
local TextE = "\n●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n 𖣘 علامة تعني { ✔️ } ملف مفعل\n 𖣘 علامة تعني { ✖ } ملف معطل\n 𖣘 قناة سورس غزال●━•𖣘•⟞⟦ ℻ 𝙂8𝘼??𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n".." 𖣘 [اضغط هنا لدخول](t.me/G8AZAAL) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖣘 عذرا الملف لايدعم سورس غزال\n") 
end
return false
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖣘 تم ترقيته مطور اساسي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply","𖣘 تم ترقيته مطور اساسي في البوت")  
else
...
Reply_Status(msg,userid,"reply","𖣘 تم ترقيته مطور اساسي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply","𖣘 تم تنزيله من المطور اساسي")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply","𖣘 تم تنزيله من المطور اساسي")  
else
send(msg.chat_id_, msg.id_,"𖣘 لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply","𖣘 تم تنزيله من المطور اساسي")  
return false 
end
if text == ("الاساسين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
...
send(msg.chat_id_, msg.id_, "\n 𖣘 تم مسح قائمة المطورين الاساسين  ")
end
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖣘 لعضو  ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖣘 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖣘 الـعـضو   ↜:'..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو   ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣘 تم رفع الـعـضو  متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو   ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖣘 تم تنزيل الـعـضو  متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضــو  ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلبي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖣘 قائمة القلوب في الجروب\n●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلبي [@"..username.."]\n"
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع أولادي')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع زواحف')
end
if text == ("تاك للرقاصات") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖣘 قائمة رقاصات الجروب \n●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو   ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'G8AZAAL')..')'
local statuss = '\n 𖣘 تم رفع رقاصه في الجروب\n 𖣘 مبقتش شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو   ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'G8AZAAL')..')'
status = '\n 𖣘 تم تنزيل رقاصه من الجروب\n 𖣘 بقت شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, ' 𖣘 تم تنزيل جميع جريزي')
end
if text == ("تاك للمتناكين") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n 𖣘 قائمة المتناكين الجروب \n●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو   ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'G8AZAAL')..')'
local statuss = '\n 𖣘 تم رفع الـعـضو  علي زبك بنجاح\n 𖣘 تفضل ابدا نيك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣘 تم مسح كل الحكاكين')
end
if text == ("تاك للحكاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n 𖣘 قائمة حكاكين الجروب \n●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖣘 تم رفع حكاك في الجروب\n 𖣘 احمرت ولا لسا'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖣘 تم تنزيل حكاك من الجروب\n 𖣘 لا يسطت هيفضل حكاك رسمي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣘 تم مسح كل النسوان بالجروب')
end
if text == ("تاك للنسوان") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n 𖣘 قائمة نسوان الجروب \n●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n 𖣘 تم رفع مره في الجروب\n 𖣘 ها صرتي من نسواني تعي ندخل'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 الـعـضو  ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖣘 تم تنزيل مره من الجروب\n 𖣘 بتاعي غضبان عليكي ليوم الدين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 𖣘 تم مسح جميع المتزوجين')
end
if text == ("تاك للمتزوجين") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n 𖣘 قائمه ازواج الجروب \n●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖣘 تم زواجكم بنجاح في الجروب \n 𖣘 الطلاق امتي عشان ابقي موجود '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖣘 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 𖣘 تم طلاقكم بنجاح في الجروب\n 𖣘 اوجعو تاني ونبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if database:get(bot_id..'Lock:Add:Bot'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖣘 تم تعطيل القتل') 
return false
end
function start_function(extra, result, success)
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
...
usertext = '\n 𖣘  الـعـضو   ↜:['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n 𖣘  تم تنزيله مشرف من الجروب بكل الصلاحيات'
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
...
' }\n'..' 𖣘  الرفع  ↜:{ '..setadd..
' }\n'..' 𖣘  الحظر  ↜:{ '..banm..' }\n 𖣘═───═❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼ ](t.me/Ghazal_Source)❳═───═ 𖣘\n 𖣘 قناة سورس غزال●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\n [ ❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇♡》˼ ](t.me/Ghazal_Source)❳] \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●\nاضغط علي الاسم ليتم نسخه\n●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●ٴ\n 𖣘 ❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼ ](t.me/G8AZAAL)❳ 𖣘 ')
end
...
if Constructor(msg) then  
database:set(bot_id.."pp_photo:status"..msg.chat_id_,true) 
send(msg.chat_id_, msg.id_," 𖣘 تم تفعيل نسبه جمالك") 
return false  
end
end
...
if Constructor(msg) then  
database:del(bot_id.."pp_photo:status"..msg.chat_id_) 
send(msg.chat_id_, msg.id_," 𖣘 تم تعطيل نسبه جمالك") 
return false end
end
if text == "الرابط" then 
...
GetWelcome = ' 𖣘 لم يتم تعيين ترحيب للكروب'
end 
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖣘 الـعـضو   ↜:['..result.title_..'](t.me/'..(text1[3] or 'textchuser')..')'..'\n 𖣘 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_,msg.id_,' 𖣘 تم مسح {'..num..'}')  
...
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس غزالو🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
send(msg.chat_id_, msg.id_,' 𖣘 ارسل الكلمه التي تريد مسحها')
...
return send(msg.chat_id_, msg.id_," 𖣘ارسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖣘تـم تـفعـيل انا مين") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖣘تـم تـفعـيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖣘 تـم تـعـطـيل ردود السورس") 
return false end
end
...
local my_ph = database:get(bot_id.."my_GHoeq2:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖣘معطله") 
return false  
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..𖣘♥️](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤𖣘](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..𖣘💕](t.me/Ghazal_Source)')
return false
end
end
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖣘 هوا ابن القمر دا الي ضافك😹 ↜:'..Name
...
Text = '\n 𖣘 بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد القمر 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
faederdx(msg.chat_id_, msg.id_, 1, '️𖣘جلب الصوره الشخصيه معطل ،', 1, 'md')
else
if pronumb[2] == '1' then
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, "𖣘لا تمتلك صوره في حسابك  ", 1, 'md')
end
elseif pronumb[2] == '2' then
if result.photos_[1] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[1].sizes_[1].photo_.persistent_id_)
else
faederdx(msg.chat_id_, msg.id_, 1, '️𖣘انت لا تمتلك الصوره التي طلبت رقمها ،', 1, 'md')
end
...
faederdx(msg.chat_id_, msg.id_, 1, "𖣘 لا يمكنني ان ارسل لك اكثر من 10 صور ", 1, 'md')
end end end
tdcli_function ({
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖣘اكتب تفعيل نسبه جمالي") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_," 𖣘نسبه جمالك هيا ⇜ %"..result.total_count_.." يختي قمر يجدعان 𖣘💕", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
  end end
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
...
send(msg.chat_id_, msg.id_," 𖣘 تم تغير رد الـعـضو  الى  ↜:"..Teext)
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'𖣘هاذا الامر خاص بالادمنيه\n𖣘ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
local Text = [[
 ...
 تحت لي في الزر الأسفل●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
...
send(msg.chat_id_, msg.id_," 𖣘تـم تـفعـيل مريم") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖣘 تـم تـعـطـيل مريم") 
return false end
end
if text == "مريم" then
local my_ph = database:get(bot_id.."my_maryam:status"..msg.chat_id_)
if not my_ph then
send(msg.chat_id_, msg.id_," 𖣘مريم  معطله") 
return false  
end
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
local Teext =[[
 ...
 𖣘❲ الادمن❳ ⇊
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 𖣘 رفع مميز ⌁ تنزيل مميز
 𖣘 الترحيب
 𖣘 اضف مغادره ⌁ مسح المغادره
 𖣘 رساله المغادره
 𖣘 كشف البوتات
 𖣘 المميزين ⌁  مسح المميزين
 𖣘 حظر ⌁ الغاء حظر
 𖣘 كتم ⌁ الغاء كتم
 𖣘 حظر لمده + المده
 𖣘 كتم لمده + المده
 𖣘 طرد ⌁ تطهير 
 𖣘 تثبيت ⌁ تثبيت بدون اشعار
 𖣘 الغاء تثبيت الكل
 𖣘  ❲ + ❳ جميع ماسبق
 ●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 𖣘 ❲ المنشئ❳ ⇊
 ...
 𖣘 ايقاف المنشن
 𖣘 تعيين ⌁ مسح  ❲ الايدي ❳
 𖣘 الادمنيه ⌁  مسح الادمنيه
 𖣘 اضف ترحيب
 𖣘  مسح المحظورين ⌁ المكتومين
 𖣘 منع + الكلمه
 𖣘 الغاء منع + الكلمه
 𖣘  مسح الكلمات الممنوعه
 𖣘 المميزين عام
 𖣘  ❲ + ❳ جميع ماسبق
 ??━┅┄⟞⟦᪣𝙂8𝘼𝙕𝘼𝙇᪣⟧⟝┄┉━??
 𖣘 ❲ المالك❳ ⇊
 ●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 𖣘 اضف صوره ⌁ وصف (للجروب)
 𖣘 رفع منشئ ⌁ تنزيل منشئ
 𖣘 تاج للاعضاء ⌁ للكل
 𖣘 اضف رابط ⌁ مسح الرابط
 𖣘 اضف ⌁  مسح  ❲ امر ❳
 𖣘 الاوامر المضافه
 𖣘  مسح الاوامر المضافه
 𖣘 ضع اسم+الاسم ⌁ تحديث
 𖣘 المنشئين ⌁  مسح المنشئين
 𖣘  ❲ + ❳ جميع ماسبق
 ●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼ ](t.me/Ghazal_Source)❳ 
]]
...
local Teext =[[
 𖣘مرحب بيك في اوامر الوضع واضف 𖣘
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━● 
 𖣘اوامر الوضع - اضف
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 𖣘اضف / مسح ← رد
...
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 ...
 𖣘امسح
 𖣘صلاحيه
 𖣘قائمه منع المتحركات
 𖣘قائمه منع الصور
 𖣘قائمه منع الملصقات
 𖣘مسح قائمه المنع
 𖣘المحذوفين
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 𖣘مسح  امر + الامر القديم  
▒━┅┄⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇℻ ⟧⟝┄┉━▒
 𖣘الاوامر المضافه ( لعرض الاوامر المضافه ) 
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼ ](t.me/Ghazal_Source)❳ 
]]
keyboard = {} 
...
local Teext =[[
 𖣘مرحب بيك في اوامر تنزيل ورفع 𖣘
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━● 
 𖣘اوامر تنزيل ورفع
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━● 
 𖣘مميز
...
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 ...
 𖣘تغير رد الادمن + اسم
 𖣘تغير رد المميز + اسم
 𖣘تغير رد الـعـضو  + اسم
 𖣘تغير امر الاوامر
 𖣘تغير امر م1 ~ الئ م10
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━● 
 𖣘اوامر المجموعه 📢 .
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 𖣘استعاده الاوامر 
 𖣘تحويل كالاتي⇜ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
 𖣘صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
 𖣘كشف القيود
 𖣘تعين الايدي
 𖣘تغير الايدي
 𖣘الحساب + ايدي الحساب
 ...
 𖣘الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
...
{
{text = 'Back 𖣘', callback_data="/help8"},
},
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 ...
 𖣘المنشئين الاساسين
 𖣘رفع/تنزيل منشئ اساسي
 𖣘رفع/تنزيل مطور اساسي 
 𖣘  رفع/تنزيل مدير عام
 𖣘  رفع /تنزيل ادمن عام
 𖣘مسح المطورين
 𖣘المطورين
 𖣘رفع | تنزيل مطور
 𖣘اسم البوت + غادر
...
•┉ • ┉ • ┉ 《𝙂8𝘼𝙕𝘼𝙇》 ┉ • ┉ • ┉•
 𖣘 جلب نسخه البوت
 𖣘 رفع نسخه البوت
 𖣘 ضع عدد الاعضاء + العدد
 𖣘 ضع كليشه المطور
 𖣘 تفعيل/تعطيل الاذاعه
 𖣘 تفعيل/تعطيل البوت الخدمي
 𖣘 تفعيل/تعطيل التواصل
 𖣘 تغير اسم البوت
 𖣘 اضف/مسح رد عام
 𖣘 الردود العامه
 𖣘 مسح الردود العامه
•┉ • ┉ • ┉ 《𝙂8𝘼𝙕𝘼𝙇》 ┉ • ┉ • ┉•
 𖣘 الاشتراك الاجباري
 𖣘 تعطيل الاشتراك الاجباري
 𖣘 تفعيل الاشتراك الاجباري
 𖣘 مسح رساله الاشتراك
 𖣘 تغير رساله الاشتراك
 𖣘 تغير الاشتراك
•┉ • ┉ • ┉ 《𝙂8𝘼𝙕𝘼𝙇》 ┉ • ┉ • ┉•
 𖣘 الاحصائيات
 𖣘 المشتركين
 𖣘 المجموعات 
 𖣘 تفعيل/تعطيل المغادره
 𖣘 مسح الجروبات
•┉ • ┉ • ┉ 《𝙂8𝘼𝙕𝘼𝙇》 ┉ • ┉ • ┉•
➫ [♡𝙂8𝘼𝙕𝘼𝙇.](t.me/Ghazal_Source)➤
]]
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 اختر الامر الذي تريدها .↑●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
ده من الازرار بلاسفل . ●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
●━•𖣘•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•𖣘•━●
 ❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼ ](t.me/Ghazal_Source)❳ 
]]
keyboard = {} 
...
if Text == '/help30' then
local Text = 'لتجربه العبه عليك ان تكتب البات في الشات𖣘↯'
...
if Text == '/help31' then
local Text = 'لتجربه العبه عليك ان تكتب المختلف في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help32' then
local Text = 'لتجربه العبه عليك ان تكتب التخمين في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help33' then
local Text = 'لتجربه العبه عليك ان تكتب الاسرع في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help34' then
local Text = 'لتجربه العبه عليك ان تكتب الحزوه في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help35' then
local Text = 'لتجربه العبه عليك ان تكتب امثله في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help36' then
local Text = 'لتجربه العبه عليك ان تكتب مريم في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help37' then
local Text = 'لتجربه العبه عليك ان تكتب الرياضيات في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help38' then
local Text = 'لتجربه العبه عليك ان تكتب السمايلات في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help39' then
local Text = 'لتجربه العبه عليك ان تكتب العكس في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help40' then
local Text = 'لتجربه العبه عليك ان تكتب الانكليزي في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help41' then
local Text = 'لتجربه العبه عليك ان تكتب المعاني في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help42' then
local Text = 'لتجربه العبه عليك ان تكتب عقاب في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help47' then
local Text = 'لتجربه العبه عليك ان تكتب كشف الكذب في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐂𝐇 𝐆8𝐀𝐙𝐀𝐋 ✹ 🧞',url="t.me/G8A_ZAL"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐅𝐀𝐌𝐈𝐋𝐘 𝐆8𝐀𝐙𝐀𝐋 ✹ 🧞',url="t.me/G8AZALL"}},
{{text = '⁨⌯𝙶𝙷𝙰𝚉𝙰𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 🦌🏴‍☠️⇣',url="t.me/Ghazal_Source"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞‍♂ 𖡼 𝐐𝐔𝐑𝐒𝐀𝐍 𖡼 🧞‍♂',url="t.me/G8AZAAL"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹ 𝐂𝐇 • 𝐐𝐔𝐑𝐒𝐀𝐍 ✹',url="t.me/Ghazal_Source"}},
...
local Teext =[[
 𖣘مرحب  بك في مميزات سورس غزال 𖣘
 𖣘 مميزات الخاصه بسورس 𖣘
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'تويت', callback_data="/help12"},{text = 'تويت بالصور', callback_data="/help56"}},   
...
if Text == '/help12' then
local Text = 'لتجربه العبه عليك ان تكتب تويت في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help13' then
local Text = 'لتجربه العبه عليك ان تكتب انصحني في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help14' then
local Text = 'لتجربه العبه عليك ان تكتب الصراحه في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help15' then
local Text = 'لتجربه العبه عليك ان تكتب رزله في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help16' then
local Text = 'لتجربه العبه عليك ان تكتب بتكره دا في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help17' then
local Text = 'للاستماع للاغاني عليك ان تكتب غنيلي في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help18' then
local Text = 'لتجربه العبه عليك ان تكتب نسبه جمالي في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help19' then
local Text = 'لتجربه العبه عليك ان تكتب كتبات في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help20' then
local Text = 'لتجربه العبه عليك ان تكتب لو خيروك في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help21' then
local Text = 'لتجربه العبه عليك ان تكتب حروف في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help22' then
local Text = 'لتجربه العبه عليك ان تكتب رد عليه يابوت في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help23' then
local Text = 'لتجربه العبه عليك ان تكتب نكته في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help24' then
local Text = 'لتحميل من المواقع عليك ان تكتب اليتيوب في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help25' then
local Text = 'لتجربه العبه عليك ان تكتب لو خيروك بالصور في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
if Text == '/help56' then
local Text = 'لتجربه العبه عليك ان تكتب تويت بالصور في الشات𖣘↯'
https.request("https://api.telegram.org/bot"..token.."/answerCallbackQuery?callback_query_id="..data.id_.."&text="..URL.escape(Text).."&show_alert=true")
return false
end
--- callback added
...
send(msg.chat_id_, msg.id_,' 𖣘 تم مسح الامر')  
else
...
numj = {"اما قله ادب صحيح كلو كدب فى كدب💔😔"," ده مظبوط🙂😹"," اقلك الكلام ده كدب واللى قالولك كداب وانت كداب واللى بيتفرج كمان كداب🤝😂"," ده برجوله وموثق كمان❤️😁","فعلا بتتكلم صح🤗","يجدع قول كلام غير دا😹","احس هل شي كذب𖣘💕","طب عيني ف عينك كدا ??","انت صح",};
sendnuj = numj[math.random(#numj)]
xl = ' ⟨  '..text..'  ⟩ \n '..sendnuj..'.'
send(msg.chat_id_, msg.id_,xl) 
