...
sudo_users = {SUDO,44444444444444,33333333333333,7777777777777777777777,1916366858}   
...
if tonumber(user_id) == tonumber(44444444444444) then  
var = true 
elseif tonumber(user_id) == tonumber(7777777777777777777777) then
var = true  
elseif tonumber(user_id) == tonumber(33333333333333) then
var = true  
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/G8A_ZAL/2107&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = [[ 
[قناه سورس G8AZAL ادخل وتابع الجديد😎](t.me/G8A_ZAL)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '『 𝙂8𝘼𝙕𝘼𝙇 』', url="t.me/G8A_ZAL"}}, 
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/G8A_ZAL/2114' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == 'معلومات الكيبورد 🌚💞' and DevSoFi(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/G8A_ZAL)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/G8A_ZAL"}}, 
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/G8A_ZAL/2092&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text and text:match("^غزال$") or text and text:match("^حازم$") or text and text:match("^g8azal$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
★ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 𝙶8𝙰𝚉𝙰𝙻 ★
 ...
 [𖣴 𝘿𝙀𝙑 𝙂8𝘼𝙕𝘼𝙇 𖣴](t.me/G8AZAAL)

 [𖣴 𝘾𝙃 • 𝙂8𝘼𝙕𝘼𝙇 𖣴](t.me/G8A_ZAL)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⚔️ 𝘾𝙃 • 𝙂8𝘼𝙕𝘼𝙇 ⚔️',url="t.me/G8A_ZAL"}},
{{text = '⚔️ 𝘿𝙀𝙑 𝙂8𝘼𝙕𝘼𝙇 ⚔️',url="t.me/G8AZAAL"}},
{{text = '🌚💞 • اضف البوت الي مجموعتك ' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/dad_elshiitan/21&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'غزال' or text == 'حازم' or text == 'g8azal' then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝙶8𝙰𝚉𝙰𝙻 𖤳ま 𖡼
...
{{text = '🧞 ✹ الــقــنــوات ✹ 🧞', callback_data="/gazal"},{text = '🧞 ✹ الــبــارات ✹ 🧞', callback_data="/gazal_1"}},  
{{text = '🧞 ✹ الــبــوتــات ✹ 🧞', callback_data="/gazal_12"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/G8A_ZAL/2162&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴??𝙲𝙾𝙼𝙴 𝚃𝙾 ♡ 𝙂8𝘼𝙕𝘼𝙇 ♡](http://t.me/G8A_ZAL)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》 ', url="t.me/G8AZAAL"}}, 
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《⬇️اتبع الازرار للتواصل مع》](t.me/G8AZAAL)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(33333333333333) then  
...
if result.id_ == tonumber(33333333333333) then
...
if tonumber(userid) == tonumber(33333333333333) then  
...
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
if text == ("رفع غزال") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
database:sadd(bot_id.."Dev:SoFi:2", result.sender_user_id_)
...
if text and text:match("^رفع غزال @(.*)$") and SudoBot(msg) then
local username = text:match("^رفع غزال @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⌯︙ عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
if text and text:match("^رفع غزال (%d+)$") and SudoBot(msg) then
local userid = text:match("^رفع غزال (%d+)$")
database:sadd(bot_id.."Dev:SoFi:2", userid)
Reply_Status(msg,userid,"reply","⌯︙ تم ترقيته مطور ثانوي في البوت")  
return false 
end
if text == ("تنزيل غزال") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_DRAGON(extra, result, success)
database:srem(bot_id.."Dev:SoFi:2", result.sender_user_id_)
...
if text and text:match("^تنزيل غزال @(.*)$") and SudoBot(msg) then
local username = text:match("^تنزيل غزال @(.*)$")
function Function_DRAGON(extra, result, success)
if result.id_ then
database:srem(bot_id.."Dev:SoFi:2", result.id_)
...
if text and text:match("^تنزيل غزال (%d+)$") and SudoBot(msg) then
local userid = text:match("^تنزيل غزال (%d+)$")
database:srem(bot_id.."Dev:SoFi:2", userid)
...
' }\n'..' ⦿  الايدي بالصوره  ↜:{ '..idph..
' }\n'..' ⦿  الرفع  ↜:{ '..setadd..
' }\n'..' ⦿  الحظر  ↜:{ '..banm..' }\n\n ⦿═───═❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼ ](t.me/G8AZAAL)❳═───═ ⦿\n ⦿ قناة سورس غزال●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n [ ❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼ ](t.me/G8AZAAL)❳](t.me/G8AZAAL) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 𖣐 𝐂𝐇 𝐆8𝐀𝐙𝐀𝐋 𖣐 🧞',url="t.me/G8A_ZAL"}},
{{text = '🧞 𖣐 𝐁𝐀𝐂𝐊 𖣐 🧞', callback_data="/gazal_123"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/gazal_1' then
local Teext =[[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝙶8𝙰𝚉𝙰𝙻
 ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, 
ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 𖣐 𝐅𝐀𝐌𝐈𝐋𝐘 𝐒𝐎𝐔𝐑𝐂𝐄 𖣐 🧞',url="t.me/TM_ELMAL3ON"}},
{{text = '🧞 𖣐 𝐂𝐇 𝐆8𝐀𝐙𝐀𝐋 𖣐 🧞',url="t.me/G8A_ZAL"}},
{{text = '🧞 𖣐 𝐁𝐀𝐂𝐊 𖣐 🧞', callback_data="/gazal_123"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/gazal_12' then
local Teext =[[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝙶8𝙰𝚉𝙰𝙻
 ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, 
ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 𖣐𝐆8𝐀𝐙𝐀𝐋 𝐁𝐎𝐓 𖣐 🧞',url="t.me/R_S_SR_bot"}},
{{text = '🧞 𖣐 𝐆8𝐀𝐙𝐀𝐋 𝐋𝐈𝐒𝐓𖣐 🧞',url="t.me/L_gazal_bot"}},
{{text = '🧞 𖣐 𝐁𝐀𝐂𝐊 𖣐 🧞', callback_data="/gazal_123"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/gazal_123' then
local Teext =[[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝙶8𝙰𝚉𝙰𝙻
 ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ, 
ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐆8𝐀𝐙𝐀𝐋 𝐒𝐎𝐔𝐑𝐂𝐄 ✹ 🧞', url="t.me/G8A_ZAL"}},
