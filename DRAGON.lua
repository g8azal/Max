...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '™✹ 𝙁𝘼𝙈𝙄𝙇𝙔 𝙎𝙊𝙐𝙍𝘾𝙀 ✹',url="t.me/TM_ELMAL3ON"}},
{{text = '✹ 𝘾𝙃 • 𝙂8𝘼𝙕𝘼𝙇 ✹',url="t.me/G8A_ZAL"}},
{{text = '◉𝙱𝙰𝙲𝙺↵', callback_data="/gazal_123"}},
}
...
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = '  『 𝙂8𝘼𝙕𝘼𝙇 』 ', url="t.me/R_S_SR_bot"}},
...
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ♡ 𝙂8𝘼𝙕𝘼𝙇 ♡](http://t.me/G8A_ZAL)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》 ', url="t.me/G8AZAAL"}}, 
