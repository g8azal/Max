...
local Text = [[ 
[قناه سورس Barlo0o ادخل وتابع الجديد](t.me/G8A_ZAL)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/G8A_ZAL/2107' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس Barlo0o ادخل وتابع الجديد](t.me/G8A_ZAL)
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/G8AZAAL)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/G8AZAAL"}}, 
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⚔️ 𝘾𝙃 • 𝙂8𝘼𝙕𝘼𝙇 ⚔️',url="t.me/G8AZAAL"}},
{{text = '⚔️ 𝘿𝙀𝙑 𝙂8𝘼𝙕𝘼𝙇 ⚔️',url="t.me/G8A_ZAL"}},
{{text = '🌚💞 • اضف البوت الي مجموعتك ' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '• داد غزال مطور سورس غزال لو حابب تتواصل معاه اضغط علي الزر •\n['..result.first_name_..'](t.me/NH_OA)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == 'غزال' or text == 'شهاب' then
local TEXT_SUD = database:get(bot_id..'Tshake:TEXT_SUDO')
if TEXT_SUDO then 
send(msg.chat_id_, msg.id_,TEXT_SUDO)
else
