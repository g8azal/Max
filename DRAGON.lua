...
sudo_users = {SUDO,22222222222222,44444444444444,1993823358,1916366858}   
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'انوبيس') 
local Groups = scard(bot_id..'Chek:Groups')  
local Users = scard(bot_id..'User_Bot')  
