...
if database:set(bot_id..'ghiktr'..msg.chat_id_)  then
Text = '\n ᥀ تم تفعيل رتبتي' 
else
...
if not database:del(bot_id..'ghiktr'..msg.chat_id_)  then
Text = '\n ᥀ تم تعطيل رتبتي' 
else
...
if text == "رتبتي" then
local ghiktr = database:get(bot_id.."ghiktr"..msg.chat_id_)
if not ghiktr then
